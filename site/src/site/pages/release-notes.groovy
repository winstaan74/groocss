import groocss.generator.DocUtils
...
layout 'layouts/main.groovy', true,
        pageTitle: "GrooCSS - The Groovy CSS DSL - $version release notes",
                    ...
                    div(class: 'row-fluid') {
                        div(class: 'col-lg-3') {
                            ul(class: 'nav-sidebar') {
                                li(class:'active') {
                                    a(href: '#releasenotes', "Release notes for GrooCSS $version")
                                }
                                sections.each { k,v ->
                                    li {
                        ...
                        div(class: 'col-lg-8 col-lg-pull-0') {
                            a(name:"releasenotes"){}
                            h1("Release notes for GrooCSS $version")
